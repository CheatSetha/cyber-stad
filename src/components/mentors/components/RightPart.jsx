...
export default function RightPart() {
  ...
  return (
    <div id="mentor-page" className="md:w-[617px]  w-[300px] max-sm:ms-3 md:h-[430px] bg-mentor flex flex-col gap-10 items-center justify-center">
        ...
        <span className=""><MentorPicCard name={'Kit Tara'} img={"/images/mentor/tara.JPG"}/></span>
        <span className="mt-16 max-[420px]:-ms-[30px] max-[420px]:mt-0"><MentorPicCard name={"Kay Keo"} img={"/images/mentor/keo.jpg"}/></span>
